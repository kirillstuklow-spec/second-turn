...
# Для длительности в раундах конец раунда наложения или обновления
# не считается полным раундом действия эффекта.
@export var skip_application_round : bool = true
